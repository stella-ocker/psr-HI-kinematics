...
## Usage
Command-line: `python h1_kinematic_distances.py`
...
## Dependencies
The command-line program requires `numpy` and the `kinematic_functions` module (which should be installed in the same directory as `h1_kinematic_distances.py`).
